...
abstract class Controller extends BaseController
{
    ...
    {
        // var_dump($request->product_belongsto_category_relationship);
        // var_dump($slug);
        // var_dump($rows);
        // var_dump($data);
        // exit;
        ...
        foreach ($rows as $row) {
            ...
            // if(isset($request->product_belongsto_category_relationship) &&count($request->product_belongsto_category_relationship)>0){
