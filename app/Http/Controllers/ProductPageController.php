...
class ProductPageController extends Controller
{
    public function index($slug){
        ...
        $productCategory = DB::table('product_pivot')->where('product_id',$product->id)->get();
        $products=Product::inRandomOrder()->where('slug','!=',$slug)->take(3)->get();


        return view('product',compact('product','reviews','products','productCategory'));
    }
    ...
    public function addToCartBooknow(Request $request){
        $validator=Validator::make($request->all(),[
            'quantity1'=>'numeric|min:1'
        ]);
